...
function  Início(){
    return (
        ...
        <div className={styles.Text}> 
            <div className={styles.TittleText}><h1 className={styles.BackgroundText}>Bem Vindo!!!</h1>
            <h2 className={styles.BackgroundText}>Tudo que você precisa aprender para construir aplicações modernas para Web você aprenderá aqui.</h2></div><br/><br/>
<p>
Desenvolvimento Web é hoje um dos assuntos mais relevantes do momento porque o mercado respira Web. E Se você deseja ser um profissional preparado para o mercado e não quer aprender apenas fórmulas, mas o porquês, esse curso é a escolha certa pra você.<br/><br/>
